...
# Use webhook mode on Cloud Run: app expects BASE_URL, not WEBHOOK_BASE_URL, and must listen on PORT=8080
ENV_VARS="BASE_URL=${SERVICE_URL},LOG_LEVEL=DEBUG,PLANNER_IMPL=llm,EXECUTOR_URL=${EXECUTOR_URL},WALLET_ADDRESS=${WALLET_ADDRESS},NETWORK=mainnet,DEFAULT_SLIPPAGE_BPS=100,ALLOWED_TELEGRAM_USER_IDS=${ALLOWED_TELEGRAM_USER_IDS},ALLOWED_TOKENS=*,MIN_TOKEN_MCAP_USD=15000000"
